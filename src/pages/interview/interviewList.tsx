...
import { History, HISTORY_TYPE, Interview, InterviewMeta, WordCount, HistorySet } from 'types/interview/interview-type';
...
const InterviewList: React.FC = () => {
    ...
    const onSelectInterview = (interviewId: number) => {
        ...
        setVideourl('/videos/interviewTest.mp4');
            ...
            <Background>
                ...
                <GlobalStyled.ViewCol className="history-div" style={{flex: 4, height: '90vh'}}>
                    ...
                    <GlobalStyled.ViewCol style={{ flex: 30, backgroundColor: 'white', overflow: 'auto' }}>
                        {
                            isHistory ? curInterview.history.map((log, idx) => {
                                return (
                                    <>
