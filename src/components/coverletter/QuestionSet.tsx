        ...
        <div style={{marginLeft:"10px"}}>
            ...
            {visible && <div>
                {visible1 && <div>
                    ...
                    <AnswerBox style={{fontFamily: 'Notosans-medium',letterSpacing: 0.5,lineHeight: 1.3}} onClick={()=> CopyClipBoard('추천1')}>추천 1<br/>제가 가장 중요하다고 생각하는 것은 '팀워크'입니다. 저는 먼저 팀원을 이끄는 책임감과 리더십을 갖추고자 합니다. 대학교에서 다양한 경험을 했고 여러 가지 아르바이트를 했습니다. 특히나 전공 수업과 학과 홍보 업무를 병행했기에 대외활동과 기획활동을 통해 더 많은 사람과 교류하는 것이 가능해졌었습니다 대학에 입학한 후에도 대학생활 동안 동아리 활동을 하면서 학내 구성원들과 함께 크고 작은 마찰이 있었음에도 화합하며 일을 해결해 나갔으며 좋은 기억으로 남을 수 있습니다. 귀사에 입사 후</AnswerBox></div>}
                
                {visible2 && <div>
                    <IconButton style={{float:"right"}} onClick={()=>{setVisible2(false);}}>
                        <CancelOutlinedIcon style={{paddingRight:"10px"}}></CancelOutlinedIcon>
                    </IconButton>
                    <AnswerBox style={{fontFamily: 'Notosans-medium',letterSpacing: 0.5,lineHeight: 1.3}} onClick={()=> CopyClipBoard('추천2')}>추천 2<br/>제가 가장 중요하다고 생각하는 것은 '직접 경험하고 느낄 수 있는 역량'입니다. 귀사에 입사하여 관련 직무에 대한 경험을 쌓고 싶습니다. 그 과정에서, 더 넓은 세상을 보며 다양한 이해관계자들과 소통한 경험과 전문성을 키우기 위해 다음과 같은 계획을 세우고 실천해 나갈 것입니다. 먼저 물류의 시작부터 끝까지 책임지는 인재로 거듭나겠습니다 지금까지 쌓아온 꼼꼼함을 바탕으로 업무에 잘 적응할 뿐만 아니라 고객의 니즈를 만족시키는 일에 관심을 두게 됩니다. 또한, 글로벌 역량을 강화하기 위한 도전</AnswerBox></div>}

                {visible3 && <div>
                    <IconButton style={{float:"right"}} onClick={()=>{setVisible3(false);}}>
                        <CancelOutlinedIcon style={{paddingRight:"10px"}}></CancelOutlinedIcon>
                    </IconButton>
                    <AnswerBox style={{fontFamily: 'Notosans-medium',letterSpacing: 0.5,lineHeight: 1.3}} onClick={()=> CopyClipBoard('추천3')}>추천 3<br/>제가 가장 중요하다고 생각하는 것은 '열정'입니다. 대학 시절 동아리 활동, 연합 토론회, 국제포럼 등 활발한 대외활동을 통해 팀워크를 이뤄왔습니다. 이러한 역량을 바탕으로 귀사에 입사하여 열정적으로 노력하겠습니다 저는 어릴 때부터 열정이 많아 남들에게 인정을 많이 받았기 때문에 주위 사람들 앞에서 먼저 발 벗고 나서서 적극적으로 말할 수 있다고 생각합니다. 그래서 평소에는 적극적인 성격을 가지고 있기 때문에, 항상 밝고 긍정적인 성격으로 사람들에게 신뢰를 받아 주변 사람들도 자신을 인정해주면서 함께 일하는 것을 좋아하기 때문입니</AnswerBox></div>}
            </div>}
